...
6. **Enter `howto` to search for the application repository named `alexa-skills-kit-nodejs-howtoskill`.** Enter the full name into the serach box if you need to narrow the search results.
