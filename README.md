...
![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/sample_utterances_us.PNG)
 ...
 8. For a How-to skill, we should also add the custom slot. Select “Add Slot Type”.
...
## Step 5: Make it Yours
 ...
 3. Open the source file for your Lambda function, index.js, in an editor of your choice. This is in the src directory of the repository you downloaded earlier. Look for corresponding locale strings in languageStrings object. "Ctrl-F" **en** for English and **de** for German. If there are different expressions between U.S. and U.K, we encourage you to specify them using **en-US** and **en-GB** while keeping a generic **en** for other countries. You can learn more about how language resources are looked up by visiting [i18next's documentation](http://i18next.com/translate/). You will see all strings defined for current language in the Minecraft Helper example. **Note**: **'%s'** in the string represents code logic variable.
![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/source_code1.png)
![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/source_code2.png)
...
You can use the Voice Simulator in the Test section to simulate Alexa’s responses. In the Voice Simulator, type in each recipe that you are using to test how Alexa will say it. Use additional punctuation or possibly SSML if you need to better control how Alexa responds. You can find out more about [SSML here](https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/speech-synthesis-markup-language-ssml-reference).
 ...
 3. Select the Publishing Information area of your skill next:
  ...
  ![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/publishing.png)
...
![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/publishing_us.png)
...
For other publishing information:
  ...
  ![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/publishing_english.png)

  ![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/publishing_english_icon.png)
...
![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/publishing_de_phrases.png)
...
6. Select **“Save”**. If your skill supports multiple languages, then you will need to complete Privacy and Compliance for each language before submission.
    ![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/privacy.png)

7. Select “Submit for Certification”
    ![](https://s3.amazonaws.com/lantern-code-samples-images/how-to/check_privacy.png)
