...
```text
Alexa, ask minecraft helper game how to build a wooden pick ax.
	>> All types of pick axs can be crafted by placing three of the desired material across the top row, and then placing sticks in the center and bottom middle squares in a crafting table.
...
2. Simulate verbal interaction with your skill through the command line using the following example:
	...
	```bash
	 $ ask simulate -l en-US -t "alexa, start minecraft helper"
